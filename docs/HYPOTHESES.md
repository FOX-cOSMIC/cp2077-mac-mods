...
- **Status:** open — untested by this project. Full research trail + source-reading notes in Claude memory (`reference_red4ext_macos_ports.md`, not part of this repo).
- **Owner:** researcher → hook-engineer (if the user approves testing)
